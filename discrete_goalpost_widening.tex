...
\pounds213.31 at best-value pricing (\pounds2.67/roll).
...
(roll~$\sim$38, \pounds101.32) before stopping. The gap between
these two endpoints --- \pounds111.99 --- defines the
...
\pounds213 rather than the \pounds80--\pounds107 it would cost at
...
A player who would have paid \pounds80 for the skin at cap~30 must
now pay \pounds213 for the identical outcome at cap~80.
...
\begin{table}[H]
\centering
\caption{RP packages with effective rolls per package. No package
yields a whole number of rolls (400~RP each).}
\label{tab:packages}
\begin{tabular}{r r r r}
\toprule
RP & GBP & Rolls covered & GBP/roll \\
\midrule
575    & \pounds4.49  & 1.44 & \pounds3.12 \\
1{,}450  & \pounds10.99 & 3.63 & \pounds3.03 \\
2{,}850  & \pounds20.99 & 7.13 & \pounds2.95 \\
5{,}000  & \pounds34.99 & 12.50 & \pounds2.80 \\
7{,}250  & \pounds49.99 & 18.13 & \pounds2.76 \\
15{,}000 & \pounds99.99 & 37.50 & \pounds2.67 \\
\bottomrule
\end{tabular}
\end{table}
...
Every package yields a fractional number of rolls. Division of each
package size by the roll cost (400~RP) never produces an integer.
This means that \emph{no single package purchase} can be exactly
exhausted through rolling --- there is always a residual RP balance.

More critically, common combinations also fail to tile onto key roll
milestones. Consider both player types:

\textbf{Casual player} targeting 150 points ($\sim$38 rolls =
15{,}200~RP):

\begin{itemize}[nosep]
    \item $1 \times 15{,}000$ RP (\pounds99.99): 200~RP short ---
          requires a top-up purchase. The cheapest option (575~RP,
          \pounds4.49) leaves 375~RP residual, totalling \pounds104.48
          for 38 usable rolls.
    \item $2 \times 7{,}250$ RP (\pounds99.98): yields 14{,}500~RP,
          still 700~RP short. A third package is required.
    \item $7{,}250 + 5{,}000 + 2{,}850$ RP (\pounds105.97): yields
          15{,}100~RP, still 100~RP short of roll~38.
\end{itemize}

\textbf{Skin-seeker} targeting the pity cap (80 rolls = 32{,}000~RP):

\begin{itemize}[nosep]
    \item $2 \times 15{,}000$ RP (\pounds199.98): yields 30{,}000~RP
          --- 2{,}000~RP (5 rolls) short. Requires a third package.
    \item $2 \times 15{,}000 + 2{,}850$ RP (\pounds220.97): yields
          32{,}850~RP --- 850~RP surplus (2.1 wasted rolls).
    \item $15{,}000 + 7{,}250 + 5{,}000 + 5{,}000$ RP (\pounds219.96):
          yields 32{,}250~RP --- 250~RP surplus.
\end{itemize}

\noindent In neither case can the player purchase exactly the RP
they need. The casual player is forced into a top-up that creates
residual RP --- a \emph{re-engagement hook} that feels wasteful to
abandon. The skin-seeker, despite committing to the largest
purchase in the system, must still overspend by \pounds7--\pounds21
beyond the idealised \pounds213 cost, and is left with surplus RP
that nudges toward further rolling.

\subsubsection*{2. Non-Uniform Increments}

The package sizes (575, 1{,}450, 2{,}850, 5{,}000, 7{,}250,
15{,}000) are not multiples of a common base. If packages were sold
in clean multiples of 400~RP --- or even in round thousands --- a
player could calculate exactly how many rolls they were buying and
purchase accordingly. Instead, the irregular increments introduce a
...
reasons ``I need about 15{,}000~RP, the big package covers that''
is implicitly accepting a 200~RP shortfall. A player who reasons
``two medium packages should be enough'' (14{,}500~RP) is 700~RP
short. In both cases, the player either stops short of their target
or buys an additional package that mostly goes to waste.
...
the system is consistently higher than the idealised best-value
figures used elsewhere in this paper. The \pounds101.32 cost for a
casual player to reach the 150-point redemption threshold assumes
perfect RP efficiency; the actual purchase cost is
\pounds104.48--\pounds105.97. For skin-seekers targeting the pity
cap, the idealised \pounds213.31 becomes \pounds219.96--\pounds220.97
in practice. In both cases, residual RP either goes unused or seeds
further spending.
...
represents \pounds112--\pounds131 of additional spend, depending on
RP package pricing.

For \textbf{skin-seekers}, the sunk cost operates in reverse:
having committed to the \pounds213+ spend from the start, they are
...
roll~60 without S1 has already spent \pounds160 and faces the
...
the max prize costs \pounds80 rather than \pounds213 --- the
...
guarantee is \pounds107 --- comparable to the casual player's
...
creates \pounds112 of sunk-cost distance beyond their exit point and
ensures that 83.5\% leave inside the uncertainty window. For
skin-seekers (targeting the max prize), the cap sets the price of
the guaranteed outcome at \pounds213 rather than the \pounds80--\pounds107
